...
const FeaturesData = [
  ...
  {
    name: "Seamless Hackathon Registration",
    icon: (
      <GiNotebook className="text-5xl text-primary group-hover:text-black duration-300" />
    ),
    link: "#",
    description: "Effortless booking process with personalized event recommendations, tailored for an enhanced hackathon experience.",
    aosDelay: "500",
  },
  {
    name: "Event Progress Updates",
    icon: (
      <SlNote className="text-5xl text-primary group-hover:text-black duration-500" />
    ),
    link: "#",
    description: "Stay informed with real-time event updates and track key hackathon milestones to maximize your experience.",
    aosDelay: "700",
  },
];

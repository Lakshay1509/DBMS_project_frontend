        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 place-items-center">
          ...
          <div className="order-2 sm:order-1  lg:pr-20 relative">
            <div className="relative z-10 space-y-5">
              ...
              A chatbot designed to simplify ticket booking for NSUT's hackathon. It provides event details, ticket options, and instant booking, ensuring a smooth experience for students and attendees.
              </p>
